...
Feature: Verification of Registration functionality
  ...
  Background: common steps among scenarios
    ...
    And I should see in the current page "A place to practice your automation skills!" and "https://automationteststore.com/"
  ...
  Scenario Outline:: should be able to registration with valid credentials
    And I enter the following details
      | First Name | Last Name | Telephone Number | Fax Number    | Company Name        | Address 1        | Address 2      | City       | Region or State | ZIP Code or Postal Code | Password     | Confirm Password |
